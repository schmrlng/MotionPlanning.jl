...
@recipe function f(G::StateSpaceGoal; dims=(1, 2))#, goal_color=:green, goal_alpha=1, goal_markershape=:star)
    # dims  --> dims
    # color :=  goal_color
    # alpha :=  goal_alpha
    # label --> ""
...
@recipe function f(G::ConfigSpaceGoal; dims=(1, 2))#, goal_color=:green, goal_alpha=1, goal_markershape=:star)
    dims  --> dims
    # color :=  goal_color
    # alpha :=  goal_alpha
    # label --> ""
